...
f = 11              #Camera lense's focal length [mm]
    ...
    ########################################################################################
        ...
        if not succes_right or not succes_left:                    
            ...
            if not results_right.detections or not results_left.detections:
                ...
                cv2.putText(frame_right, "Distance: " + str(abs(round(depth,1))), (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0),3)
                cv2.putText(frame_left, "Distance: " + str(abs(round(depth,1))), (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0),3)
                # Multiply computer value with 205.8 to get real-life depth in [cm]. The factor was found manually.
                print("Depth: ", str(abs(round(depth,1))))
